...
export default function Index({ testimonials, landingPage }) {
  return (
    <>
      {/* Static background */}
      <div className="fixed inset-0 bg-indigo-200"></div>
      <div className="relative">
        <header className="mx-auto flex max-w-6xl items-center gap-16 bg-white py-4 px-4 sm:px-6 lg:px-8">
          ...
          <nav className="flex w-full items-center justify-between">
            ...
            <Link
              href="#"
              className="rounded-full bg-black px-3 py-2 text-white"
            >
              Sign up
            </Link>
          </nav>
        ...
        <main className="relative z-20 mb-[800px]">
          {/* Hero */}
